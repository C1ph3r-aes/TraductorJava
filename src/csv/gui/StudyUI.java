...
public record StudyUI(Node rootNode) {
    ...
    public static StudyUI create(Lists listClass, AtomicInteger currentIndex, ArrayList<Integer> currentIntList, SimpleBooleanProperty resetUI) {
        ...
        Label labelWord = new Label("Word: " + listClass.getWordAt(currentIntList.get(currentIndex.get())));
        ...
        buttonNext.setOnAction(event -> {
            ...
            if (currentIndex.get() < listClass.getNbrWords() && Objects.equals(buttonNext.getText(), "Next")) {
                labelWord.setText("Word: " + listClass.getWordAt(currentIntList.get(currentIndex.get())));
        ...
        buttonShowDef.setOnAction(event -> {
            ...
            if(!Objects.equals(buttonNext.getText(), "Redo")) {
                if (Objects.equals(buttonShowDef.getText(), "Show definition")) {
                    labelDefinition.setText("Definition: " + listClass.getDefAt(currentIntList.get(currentIndex.get())));
